...
object WeatherStaticData {
    ...
    private val sveLokacije: MutableList<Lokacija> = mutableListOf(
        Lokacija("Sarajevo", "Bosna i Hercegovina", 43.85, 18.39, "Po satu", korisnikUpisan = true),
        Lokacija("Mostar", "Bosna i Hercegovina", 43.34, 17.81, "Po danu", korisnikUpisan = true),
        Lokacija("Banja Luka", "Bosna i Hercegovina", 44.77, 17.19, "Sedmično", korisnikUpisan = true),
        Lokacija("Tuzla", "Bosna i Hercegovina", 44.53, 18.67, "Po satu", korisnikUpisan = false),
        Lokacija("Zenica", "Bosna i Hercegovina", 44.20, 17.90, "Po danu", korisnikUpisan = false),
        Lokacija("Beograd", "Srbija", 44.78, 20.44, "Sedmično", korisnikUpisan = false),
        Lokacija("Zagreb", "Hrvatska", 45.81, 15.97, "Po satu", korisnikUpisan = false),
        Lokacija("Ljubljana", "Slovenija", 46.05, 14.50, "Po danu", korisnikUpisan = false),
        Lokacija("Podgorica", "Crna Gora", 42.43, 19.25, "Sedmično", korisnikUpisan = false),
        Lokacija("Skoplje", "Sjeverna Makedonija", 41.99, 21.43, "Po satu", korisnikUpisan = false)
    )

    // Pomoćna funkcija za generisanje 10 satnih prognoza
    ...
    // Pomoćna funkcija za generisanje 7 dnevnih prognoza
    ...
    private val prognoze: Map<String, Prognoza> = mapOf(
        "Sarajevo" to Prognoza("Sarajevo", 15f, 14f, "Djelomično oblačno", 15f, "SZ", 4f, null, 65, 1012, 10, 40, 11f, 22f, "partly_cloudy", generisiSatne(), generisiDnevne()),
        "Mostar" to Prognoza("Mostar", 32f, 35f, "Vedro i vruće", 8f, "J", 8f, null, 40, 1008, 12, 10, 20f, 34f, "sunny", generisiSatne(), generisiDnevne()),
        "Banja Luka" to Prognoza("Banja Luka", 22f, 22f, "Ugodno i toplo", 12f, "Z", 5f, null, 55, 1015, 10, 20, 12f, 25f, "sunny", generisiSatne(), generisiDnevne()),
        "Tuzla" to Prognoza("Tuzla", 14f, 13f, "Pljuskovi", 22f, "S", 2f, 4.5f, 85, 1009, 8, 90, 10f, 16f, "rainy", generisiSatne(), generisiDnevne()),
        "Zenica" to Prognoza("Zenica", -2f, -5f, "Mraz i hladno", 5f, "I", 1f, null, 70, 1022, 9, 5, -5f, 2f, "sunny", generisiSatne(), generisiDnevne()),
        "Beograd" to Prognoza("Beograd", 18f, 18f, "Grmljavinsko nevrijeme", 55f, "JI", 3f, 12f, 90, 1002, 6, 95, 12f, 20f, "stormy", generisiSatne(), generisiDnevne()),
        "Zagreb" to Prognoza("Zagreb", 16f, 15f, "Oblačno", 10f, "SZ", 3f, null, 70, 1014, 10, 80, 11f, 18f, "cloudy", generisiSatne(), generisiDnevne()),
        "Ljubljana" to Prognoza("Ljubljana", 12f, 10f, "Magla", 4f, "Z", 1f, null, 95, 1018, 2, 100, 8f, 14f, "foggy", generisiSatne(), generisiDnevne()),
        "Podgorica" to Prognoza("Podgorica", 28f, 29f, "Pretežno sunčano", 14f, "SI", 7f, null, 45, 1011, 11, 15, 18f, 30f, "partly_cloudy", generisiSatne(), generisiDnevne()),
        "Skoplje" to Prognoza("Skoplje", 24f, 24f, "Sunčano", 6f, "J", 6f, null, 50, 1013, 10, 10, 13f, 26f, "sunny", generisiSatne(), generisiDnevne())
    )
